...
tabItem(tabName = "boxplot1",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__3_", "Title 3", "Average Total Payment by Hospital Region"),
             numericInput("titleFont__3_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__3_", "Legend Title", "Diseases"),
             numericInput("legendTitleSize__3_", "Legend Title Size", 8),
             numericInput("legendItemSize__3_", "Legend Item Size", 5), #both 10
             numericInput("legendKeySize__3_", "Legend Key Size", 5)), 
          tabPanel("Axis Labels",
             textInput("xLabel__3_", "x-Axis Label", "Hospital Regeion"),
