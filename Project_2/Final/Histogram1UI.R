...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__2_", "Title 1", "City Hospital Costs"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__2_", "x-Axis Label", "Hospital Costs"),
             textInput("yLabel__2_", "y-Axis Label 1", "Hospital Costs Count"),
