...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__1_", "Title 1", "City Hospital Costs"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__1_", "x-Axis Label", "Hospital Costs"),
             textInput("yLabel__1_", "y-Axis Label 1", "Hospital Costs Count"),
