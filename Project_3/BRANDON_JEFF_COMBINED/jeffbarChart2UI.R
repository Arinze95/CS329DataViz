...
tabItem(tabName = "Barchart",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__4_", "Title 1", "Healthcare Expenditure by Country"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__4_", "x-Axis Label", "Category"),
             textInput("yLabel__4_", "y-Axis Label 1", "Expedniture as Percentage of GDP"),
