...
tabItem(tabName = "boxplot1",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
                   textInput("title__1_", "Title 1", "children per women"),
                   numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
                   textInput("legendTitle__1_", "Legend Title", "population proportion under 15"),
          ...
          tabPanel("Axis Labels",
                   textInput("xLabel__1_", "x-Axis Label", "Country"),
                   textInput("yLabel__1_", "y-Axis Label 1", "Children per women"),
