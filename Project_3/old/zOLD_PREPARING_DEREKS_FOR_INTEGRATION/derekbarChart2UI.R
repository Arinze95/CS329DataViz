...
tabItem(tabName = "Density",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__7_", "Title 1", "Region Sales"),
             numericInput("titleFont__7_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__7_", "Legend Title", "Regions"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__7_", "x-Axis Label", "Category"),
             textInput("yLabel__7_", "y-Axis Label 1", "Sum(Sales) Percent"),
