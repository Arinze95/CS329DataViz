dfB <- eventReactive(c(input$selectRegion_1,input$ExpFilter), { 
...
dfB1 <- eventReactive(c(input$ExpFilter,input$selectRegion_1, input$yDataMin__1_, input$yDataMax__1_), { 
