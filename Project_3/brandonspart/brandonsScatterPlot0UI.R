...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Legend",
             ...
             numericInput("legendTitleSize__0_", "Legend Title Size", 8),
             numericInput("legendItemSize__0_", "Legend Item Size", 6),
             numericInput("legendKeySize__0_", "Legend Key Size", 5)), 
