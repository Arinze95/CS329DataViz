...
```{r}
inputPanel(
  selectInput("selectRegion_1", label = "Select Region",choices = regions, multiple=TRUE, selected=c("SUB-SAHARAN AFRICA", "OCEANIA", "LATIN AMER. & CARIB", "NEAR EAST", "ASIA (EX. NEAR EAST)", "C.W. OF IND. STATES", "EASTERN EUROPE", "NORTHERN AFRICA")),
