...
tabItem(tabName = "Density",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__2_", "Title 1", "Gross National Income per Capita by Region"),
             numericInput("titleFont__2_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__2_", "Legend Title", "Region"),
             numericInput("legendTitleSize__2_", "Legend Title Size", 10),
             numericInput("legendItemSize__2_", "Legend Item Size", 8),
             numericInput("legendKeySize__2_", "Legend Key Size", 5)), 
          tabPanel("Axis Labels",
             textInput("xLabel__2_", "x-Axis Label", "Region"),
             textInput("yLabel__2_", "y-Axis Label 1", "Gross National Income per Capita"),
