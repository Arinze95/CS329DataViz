...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__1_", "Title 1", "Population Proportion Under 15 by Region"),
             numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__1_", "Legend Title", "Region"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__1_", "x-Axis Label", "Population Proportion Under 15"),
             textInput("yLabel__1_", "y-Axis Label 1", "Count Population Proportion Under 15"),
