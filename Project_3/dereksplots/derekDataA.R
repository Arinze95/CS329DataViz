dfA <- eventReactive(c(input$selectRegion_1, input$PopFilter_1), { 
  ...
  paramQuery <- data.world::qry_sql(
    ...
    order by region
    ")
  paramQuery$params <- c(input$PopFilter_1[1], input$PopFilter_1[2], input$selectRegion_1[1], input$selectRegion_1[2], input$selectRegion_1[3], input$selectRegion_1[4], input$selectRegion_1[5], input$selectRegion_1[6], input$selectRegion_1[7], input$selectRegion_1[8], input$selectRegion_1[9], input$selectRegion_1[10], input$selectRegion_1[11])
