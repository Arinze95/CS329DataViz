# Change "Density", all __3_s, and edit tiles below:
tabItem(tabName = "Density",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__3_", "Title 1", "Age Dependency Ratio by Region"),
             numericInput("titleFont__3_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__3_", "Legend Title", "Region"),
          ...
          tabPanel("Axis Labels",
             ...
             textInput("yLabel__3_", "y-Axis Label 1", "Age Dependency Ratio"),
        ...
        plotlyOutput("Density__3_", height=800)
)
