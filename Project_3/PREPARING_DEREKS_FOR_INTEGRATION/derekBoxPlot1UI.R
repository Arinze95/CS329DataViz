...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__6_", "Title 1", "Population Proportion Under 15 by Region"),
             numericInput("titleFont__6_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__6_", "Legend Title", "Region"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__6_", "x-Axis Label", "Population Proportion Under 15"),
             textInput("yLabel__6_", "y-Axis Label 1", "Count Population Proportion Under 15"),
