dfBJeff <- eventReactive(c(input$selectRegion_1,input$ExpFilter), { 
...
dfB1Jeff <- eventReactive(c(input$ExpFilter,input$selectRegion_1, input$yDataMin__4_, input$yDataMax__4_), { 
