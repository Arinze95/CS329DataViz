...
#Introduction
Our Dataset comes from the United States Department of Homeland Security and shows TSA data over claims from airlines around the globe. Fields of particular interest include the airline, type of claim, item category, incident date, and close amount.
...
#Data table to match selected Airlines and Close Amount
...
#Boxplots - Close Amount vs. Airport
...
#Boxplots - Close Amount vs. Airport over time
