...
tabItem(tabName = "boxplot1",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
                   textInput("title__9_", "Title 1", "Gross National Income per Capita by Regeion, System of Government"),
                   numericInput("titleFont__9_", "Title Font", 10)), 
          tabPanel("Plot Legend",
                   textInput("legendTitle__9_", "Legend Title", "System of Government"),
                   numericInput("legendTitleSize__9_", "Legend Title Size", 7), #was 8,7,7
                   numericInput("legendItemSize__9_", "Legend Item Size", 5), 
                   numericInput("legendKeySize__9_", "Legend Key Size", 5)), 
          tabPanel("Axis Labels",
                   textInput("xLabel__9_", "x-Axis Label", "Region"),
                   textInput("yLabel__9_", "y-Axis Label 1", "Gross National Income per Capita"),
