...
tabItem(tabName = "Barchart",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__2_", "Title 1", "Median Age"),
             numericInput("titleFont__2_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__2_", "Legend Title", "System of Gov."),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__2_", "x-Axis Label", "Regions"),
             textInput("yLabel__2_", "y-Axis Label 1", "Median Age"),
