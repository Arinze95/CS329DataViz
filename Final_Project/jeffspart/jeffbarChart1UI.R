...
tabItem(tabName = "Barchart",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__1_", "Title 1", "Contraceptive Prevalence by Region"),
             numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__1_", "Legend Title", "System of Gov."),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__1_", "x-Axis Label", "Regions"),
             textInput("yLabel__1_", "y-Axis Label 1", "Contraceptive Prevalence"),
