...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__3_", "Title 1", "Contraceptive Prevalence vs. Median Age"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__3_", "x-Axis Label", "Contraceptive Prevalence"),
             textInput("yLabel__3_", "y-Axis Label 1", "Median Age"),
