...
tabItem(tabName = "Density",
        tabsetPanel( 
          ...
          tabPanel("Plot Legend",
             textInput("legendTitle__8_", "Legend Title", ""),
             numericInput("legendTitleSize__8_", "Legend Title Size", 10), #was 10,10,5
             numericInput("legendItemSize__8_", "Legend Item Size", 5),
             numericInput("legendKeySize__8_", "Legend Key Size", 2)), 
