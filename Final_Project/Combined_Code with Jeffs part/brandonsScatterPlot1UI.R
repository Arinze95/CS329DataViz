...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Legend",
             ...
             numericInput("legendTitleSize__1_", "Legend Title Size", 6), #was 8,6,5
             numericInput("legendItemSize__1_", "Legend Item Size", 4),
             numericInput("legendKeySize__1_", "Legend Key Size", 2)), 
