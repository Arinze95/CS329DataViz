...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__7_", "Title 1", "Avg Total Income"),
             numericInput("titleFont__7_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__7_", "Legend Title", ""),
             numericInput("legendTitleSize__7_", "Legend Title Size", 10), #was 5,5,5
             numericInput("legendItemSize__7_", "Legend Item Size", 6),
             numericInput("legendKeySize__7_", "Legend Key Size", 2)), 
          tabPanel("Axis Labels",
             textInput("xLabel__7_", "x-Axis Label", "Cities"),
             textInput("yLabel__7_", "y-Axis Label 1", "Avg Total Income"),
