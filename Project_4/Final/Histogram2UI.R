...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__5_", "Title 1", "Avg Total Income by City"),
             numericInput("titleFont__5_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__5_", "Legend Title", "Cities"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__5_", "x-Axis Label", "Average Total Income"),
             textInput("yLabel__5_", "y-Axis Label 1", "Avg Total Income Count"),
