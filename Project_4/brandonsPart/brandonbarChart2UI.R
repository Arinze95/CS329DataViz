...
tabItem(tabName = "Barchart",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__4_", "Title 1", "Average Price per Night by City, by Pet Policy"),
             numericInput("titleFont__4_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__4_", "Legend Title", ""),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__4_", "x-Axis Label", "City"),
             textInput("yLabel__4_", "y-Axis Label 1", "Average Price per Night"),
